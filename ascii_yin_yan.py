...
osc1 = oscillator.Oscillator(oscillator.fps_to_sample_rate(SAMPLE_RATE), 410.0)
osc2 = oscillator.Oscillator(oscillator.fps_to_sample_rate(SAMPLE_RATE), 410.0, math.pi)

center = Vector(WIDTH / 2, HEIGHT / 2)

chains = []
chains.append(AsciiChain(display, WHITE, PENS_BLUE, center, scale=5, length=1, char_rate=100))
chains.append(AsciiChain(display, WHITE, PENS_BLUE, center, scale=3, length=10, char_rate=150))
chains.append(AsciiChain(display, WHITE, PENS_VIOLET, center, scale=3, length=10))
